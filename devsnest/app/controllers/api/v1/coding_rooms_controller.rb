  ...
  module V1
    class CodingRoomsController < ApplicationController
      ...
      def show
        ...
        user_room_details = CodingRoom.where(id: user_coding_room.id).select(:id, :unique_id, :name, :starts_at, :topics, :difficulty, :question_count, :room_time, :finish_at, :is_active).first

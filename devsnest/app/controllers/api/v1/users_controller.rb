...
module Api
  module V1
    class UsersController < ApplicationController
      ...
      before_action :user_auth, only: %i[logout me update connect_discord onboard markdown_encode upload_files email_verification_initiator dashboard_details create_github_commit connect_github]

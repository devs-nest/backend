  ...
  module V1
    class UsersController < ApplicationController
      ...
      def me
        ...
        redirect_to "https://api.devsnest.in/api/v1/users/#{@current_user.id}", allow_other_host: true
      end
      ...
      def get_by_username
        ...
        redirect_to "https://api.devsnest.in/api/v1/users/#{user.id}", allow_other_host: true
      end

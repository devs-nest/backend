...
#Submission.create(user_id: '4', unique_id: 'Q6', status: 0)
Submission.create(user_id: '4', content_id: 'Q7', status: 1)
Submission.create(user_id: '4', content_id: 'Q81', status: 0)
Submission.create(user_id: '4', content_id: 'Q91', status: 2)
Submission.create(user_id: '4', content_id: 'Q12', status: 1)
Submission.create(user_id: '4', content_id: 'Q55', status: 0)
...
langs = ["python3", "cpp", "java", "javascript"]
...
Language.find_or_create_by(judge_zero_id: 54, name: "cpp", type_array: "vector<_>" , type_matrix: "vector<vector<_>>", type_string: "_", type_primitive: "_") if Language.find_by_judge_zero_id(54).nil?

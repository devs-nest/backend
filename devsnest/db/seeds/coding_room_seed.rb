...
CodingRoom.create(name: 'DN-Team', room_time: 0, challenge_list: [1,2,3], user_id: User.first.id, starts_at: Time.now, difficulty: ["easy"].to_json, question_count: 3, topics: ["array"].to_json)
